...
function handleWaitlistSubmit(e) {
    e.preventDefault();
    hideWaitlistModal();
    alert("✅ You're on the ClearCurve Waitlist! Early access briefing coming in Q3 2026.");
}
...
window.onload = () => {
    ...
    console.log('%c🚀 ClearCurve AI — Production Ready', 'color:#00f5ff;font-weight:bold;font-size:14px');
};
